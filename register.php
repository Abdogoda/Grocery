...
<body>
        ...
        <header class="header">
            ...
            <div class="icons">
                ...
                <div class="lang-btn" data-title="Arabic"><a href="register2.php"><i class="fas fa-language"></i></a></div>
            </div>
        </header>
                    ...
                    <div class="card" style="height: 580px;">
                        ...
                        <div class="card-front">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="tel" class="input-box" name="phone" placeholder="Your Phone" >
                                <input type="text" class="input-box" name="address" placeholder="Your Address" >
                            ...
                            <a href="login.php" class="btn btn-secondary text-white w-50 my-3">I've An Account</a>
                        </div>
                    </div>
                </div>
            </center>
